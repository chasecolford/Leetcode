# straight from the solution, their answer was very clean. nothing to change really.
class Solution(object):
    def solve(self, board):
        ...
        borders = chain(product(range(self.ROWS), [0, self.COLS - 1]), product([0, self.ROWS - 1], range(self.COLS)))
